...
# Style definitions
set style line 1 lc rgb "#C0C0C0" lw 3 dashtype 2    # Ideal speedup (gray dashed)
...
set style line 5 lc rgb "#808080" lw 2 dashtype 2    # 100% efficiency reference
...
# Plot with filled speedup region
plot 'speedup_with_error.txt' using 1:1 with lines lw 3 lc rgb "#C0C0C0" dashtype 2 title "Ideal Speedup", \
     ...
     100 axes x1y2 with lines lw 2 lc rgb "#808080" dashtype 2 title "100% Efficiency", \
...
plot 'speedup_with_error.txt' using 1:1 with lines lw 3 lc rgb "#C0C0C0" dashtype 2 title "Ideal Speedup", \
     ...
     100 axes x1y2 with lines lw 2.5 lc rgb "#808080" dashtype 2 title "100% Efficiency", \
